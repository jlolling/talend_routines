						...
						for (JsonNode nodeProduct2RO : nodeProduct2ROArray) {
							...
							if (TimestampUtil.isOverlapping(refValidFrom, refValidTo, compValidFrom, compValidTo)) {
								...
								if (inConflict) {
									...
									party1Node.set("share_percent", nodeProduct1RO.get("share_percent"));
									...
									party1Node.withArray("dispute_parties").add(nodeProduct2RO.get("businesspartner"));
									...
									party2Node.set("share_percent", nodeProduct2RO.get("share_percent"));
									...
									party2Node.withArray("dispute_parties").add(nodeProduct1RO.get("businesspartner"));
